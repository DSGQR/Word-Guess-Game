var Hangman = (function () {
    ...
    function Hangman(elId) {
        ...
        // Dom is ready
        this.elId       = elId;
        this.words      = ['PROGRAMMER', 'BRAINSTORM', 'CREATIVE', 'LOLLIPOP', 'CULTURE', 'RAZORSHARP', 'SCREWDRIVER', 'TYPEWRITER', 'JAVASCRIPT'];
    }
    ...
    Hangman.prototype.guess = function (guess) {
        ...
        if (this.WORD.indexOf(guess) < 0) {
            ...
            // Victory
            this.showElementByIdWithContent(this.elId + "_end", "You Win!<br/>The word was: " + this.WORD);
            this.STOPPED = true;
            return;
        }
